...
export const enableFormSuaNhieuCot = () => {
  $('.form-sua-nhieu-cot')
    .removeClass('d-none')
    .addClass('d-block')
}
export const disabledFormSuaNhieuCot = () => {
  $('.form-sua-nhieu-cot')
    .removeClass('d-block')
    .addClass('d-none')
}

export const FormSuaNhieuCot = props => {
  ...
  const { onChangeActiveControl, handleXoaNhieuCot } = props
  const handleSave = async () => {
    if (handleSuaNhieuCot) {
      for (
        let i = 0;
        i < get_state_sua_nhieu_cot_ref_copy_list.current.length;
        i++
      ) {
        await handleSuaNhieuCot(
          get_state_sua_nhieu_cot_ref.current,
          get_list_root_folder_ref.current,
          get_state_sua_nhieu_cot_ref_copy_list.current[i].uuid_cot
        )
      }
      await dispatch(setStateSuaNhieuCot([...[]]))
    }
  }
  const [
    ...
    state_sua_nhieu_cot.length == 0
      ? BASE_COT
      : state_sua_nhieu_cot[state_sua_nhieu_cot.length - 1]
  )

  const [
    state_sua_nhieu_cot_ref_copy_list,
    set_state_sua_nhieu_cot_ref_copy_list,
    get_state_sua_nhieu_cot_ref_copy_list
  ] = useStateRef(state_sua_nhieu_cot.length == 0 ? [] : state_sua_nhieu_cot)
  const [
  ...
  ] = useStateRef(get_state_sua_nhieu_cot_ref.current.phu_kien_cap_ADSS)
  const [
    phu_kien_cap_AC_ref,
    set_phu_kien_cap_AC_ref,
    get_phu_kien_cap_AC_ref
  ] = useStateRef(get_state_sua_nhieu_cot_ref.current.phu_kien_cap_AC)
  //  CHANGE
  ...
  const handleChangeBeCap = e => {
    ...
    let arr = get_state_sua_nhieu_cot_ref_copy_list.current
    arr[arr.length - 1] = {
      ...get_state_sua_nhieu_cot_ref.current,
      be_cap: get_be_cap_ref.current
    }
    dispatch(setStateSuaNhieuCot([...arr]))
  }
  ...
  const handleChangeCurrentSuaNhieuCot = e => {
    /**
  ...
  // END CHANGE
  // HANDLE
  const handleSuaNhieuCot = (cot, list_root_folder_local, uuid_cot_local) => {
    /**
      ...
      if (list_root_folder_local[i].uuid_folder == cot.uuid_folder) {
        for (let k in list_root_folder_local[i].list_group_duong_va_cot) {
          if (
            ...
            list_root_folder_local[i].list_group_duong_va_cot[k] = {
              ...cot,
              name: list_root_folder_local[i].list_group_duong_va_cot[k].name,
              coor: list_root_folder_local[i].list_group_duong_va_cot[k].coor,
              uuid_folder: list_root_folder_local[i].uuid_folder,
              uuid_cot : uuid_cot_local
            }
            dispatch(changeRootFolder([...list_root_folder_local]))
            Const_Libs.TOAST.success('Đã lưu cột.')
            disabledFormSuaNhieuCot()
            break
          }
        }
        break
  ...
  useEffect(() => {
    ...
    set_state_sua_nhieu_cot_ref_copy_list(
      state_sua_nhieu_cot.length == 0 ? [] : state_sua_nhieu_cot
    )
    set_cot_ref(get_state_sua_nhieu_cot_ref.current.cot)
    set_vat_tu_ref(get_state_sua_nhieu_cot_ref.current.vat_tu)
    set_phu_kien_ref(get_state_sua_nhieu_cot_ref.current.phu_kien)
    set_be_cap_ref(get_state_sua_nhieu_cot_ref.current.be_cap)
    set_phu_kien_cap_AC_ref(get_state_sua_nhieu_cot_ref.current.phu_kien_cap_AC)
    set_phu_kien_cap_ADSS_ref(
      get_state_sua_nhieu_cot_ref.current.phu_kien_cap_ADSS
    )
  }, [state_sua_nhieu_cot])
  useEffect(() => {
  ...
  return (
    <aside className='js-navbar-vertical-aside form-sua-nhieu-cot d-none form-rj navbar navbar-vertical-aside navbar-vertical navbar-vertical-right navbar-expand-xl navbar-bordered navbar-vertical-aside-initialized'>
        ...
        <div className='navbar-vertical-footer-offset position-relative h-100'>
          ...
          <div className='navbar-vertical-content pt-2 position-relative body-form-rj mb-4'>
            ...
            <div className='row pl-4 pr-4 mr-0 ml-0 mb-2 d-flex justify-content-around form-group'>
              <div className='hs-unfold mr-2  ' title='Xóa nhiều cột'>
                <a
                  data-attr='xoa_cot'
                  ...
                  onClick={() => {
                    handleXoaNhieuCot(
                      get_list_root_folder_ref.current,
                      get_state_sua_nhieu_cot_ref.current.uuid_folder
                    )
                  }}
                >
                  <img
            ...
            <div className='row p-0 mr-0 ml-0 mb-2  form-group'>
              ...
              <div className='col-sm-6'>
                <input
                  ...
                  name='name'
                  value={
                    get_state_sua_nhieu_cot_ref.current.name != null
                      ? get_state_sua_nhieu_cot_ref.current.name
                      : ''
                  }
                  onChange={handleChangeCurrentSuaNhieuCot}
                  placeholder='Tên cột'
                />
              </div>
            </div>
            <div className='row p-0 mr-0 ml-0 mb-2  form-group '>
              ...
              <div className='col-sm-6'>
                <input
                  ...
                  name='dia_diem'
                  value={
                    get_state_sua_nhieu_cot_ref.current.dia_diem != null
                      ? get_state_sua_nhieu_cot_ref.current.dia_diem
                      : ''
                  }
                  onChange={handleChangeCurrentSuaNhieuCot}
            ...
            <div className='row p-0 mr-0 ml-0 mb-2 form-group '>
              ...
              <div className='col-sm-6'>
                <input
                  ...
                  placeholder='Kinh độ'
                  value={
                    get_state_sua_nhieu_cot_ref.current.coor != null
                      ? get_state_sua_nhieu_cot_ref.current.coor[0]
                      : ''
                  }
                />
              </div>
            ...
            <div className='row p-0 mr-0 ml-0 mb-2 form-group '>
              ...
              <div className='col-sm-6'>
                <input
                  ...
                  value={
                    get_state_sua_nhieu_cot_ref.current.coor != null
                      ? get_state_sua_nhieu_cot_ref.current.coor[1]
                      : ''
                  }
                />
              </div>
            ...
            <div className='row p-0 mr-0 ml-0 mb-2 form-group  d-flex no-wrap'>
              ...
              <div className='col-sm-6 d-flex align-items-center'>
                <label className='toggle-switch' htmlFor='ly_trinh_sua_nhieu'>
                  <input
                    id='ly_trinh_sua_nhieu'
                    onChange={handleChangeCurrentSuaNhieuCot}
                    name='check_ly_trinh'
                    type='checkbox'
                    ...
                    value={
                      get_state_sua_nhieu_cot_ref.current.check_ly_trinh != null
                        ? JSON.parse(
                            get_state_sua_nhieu_cot_ref.current.check_ly_trinh
                          )
                        : false
                    }
                    checked={JSON.parse(
            ...
            >
              ...
              <div className='col-sm-6'>
                <input
                  ...
                  value={
                    get_state_sua_nhieu_cot_ref.current.ly_trinh != null
                      ? get_state_sua_nhieu_cot_ref.current.ly_trinh
                      : ''
                  }
                />
              </div>
            ...
            <div className='row p-0 mr-0 ml-0 mb-2 form-group  d-flex no-wrap'>
              ...
              <div className='col-sm-6 d-flex align-items-center'>
                <label className='toggle-switch' htmlFor='x2_pk_cot_sua_nhieu'>
                  <input
                    id='x2_pk_cot_sua_nhieu'
                    onChange={handleChangeCurrentSuaNhieuCot}
                    ...
                    value={
                      get_state_sua_nhieu_cot_ref.current.x2_phu_kien_cot !=
                      null
                        ? JSON.parse(
                            get_state_sua_nhieu_cot_ref.current.x2_phu_kien_cot
                          )
            ...
            <div className='row p-0 mr-0 ml-0 mb-2 form-group  d-flex no-wrap'>
              ...
              <div className='col-sm-6 d-flex align-items-center'>
                <label
                  ...
                  htmlFor='dat_bien_bao_sua_nhieu'
                >
                  <input
                    id='dat_bien_bao_sua_nhieu'
                    onChange={handleChangeCurrentSuaNhieuCot}
                    name='dat_bien_bao'
                    type='checkbox'
                    className='toggle-switch-input'
                    ...
                    value={
                      get_state_sua_nhieu_cot_ref.current.dat_bien_bao != null
                        ? JSON.parse(
                            get_state_sua_nhieu_cot_ref.current.dat_bien_bao
                          )
                        : false
                    }
                    checked={JSON.parse(
